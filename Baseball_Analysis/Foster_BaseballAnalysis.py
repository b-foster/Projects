...
# Imports the different datasets based on year and data type
...
# Combining the previous datasets into yearly structured data 
...
# Renaming Function for adjusting the names of the dataset columns
renaming(year20)
renaming(year19)
renaming(year18)
renaming(year17)
...
# Function for plotting histograms based on a variable and parameters    
...
# Describes a variable with the describe function and Mode, Variance, and Standard Deviation
...
# Testing a variable, comparing American and National Leagues
def ALvsNL(variable):
    ...
    print('Pearson Correlation: ' + str(st.pearsonr(AL, NL)))
    print('\n')
  
    
# Plotting the comparable distribution of a variable from 2017-2020
...
# Function for plotting a correlation heatmap
...
# Function for plotting AL vs NL during the 2020 season
def ALvsNLcomp20():
    fig = plt.figure()
...
# Function for plotting AL vs NL during the 2019 season
def ALvsNLcomp19():
    fig = plt.figure()
    ax1 = fig.add_axes([0, 0, 0.5, 0.9],
                       xlim=(0.35, 0.51))
...
# Function for comparing the 2020 Season to the previous 3 seasons
def Comparing2020(variable):
    
    # Creates an American League (AL) variable, consisting of the variable data from 2017-2019
    AL = AL19[variable].append(
        AL18[variable]).append(AL17[variable])
    
    # Creates an National League (NL) variable, consisting of the variable data from 2017-2019
    NL = NL19[variable].append(
        NL18[variable]).append(NL17[variable])
    
    # T-test and ANOVA for AL and NL
    ...
    print('Test for {}:'.format(variable))
    print('National League - 2020: {} vs 2017-2019: {}'.format(np.mean([NL20[variable]]), np.mean(NL)))
    print(nl_ttest)
    print(nl_ftest)
    print('\n')
    print('American League - 2020: {} vs 2017-2019: {}'.format(np.mean(AL20[variable]), np.mean(AL)))
    print(al_ttest)
    print(al_ftest)
    print('\n') 
...
# Function for plotting the CDF of TotalRuns
def OPS_cdf(log=False):
    ...
    # Creates a log scale of the distribution
    else:
...
# Function for plotting a scatterplot of different variables
def ScatterPlot(var1, var2, title, xlab, ylab):
    
    # Creates a new variable, combining the years of 2017-2020
...
# Function for plotting different variables with distribution curve comparing 2020 and 2017-2019
...
# The main function housing the details and run functions for the program      
def main():
